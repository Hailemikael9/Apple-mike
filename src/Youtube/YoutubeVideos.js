...
function YoutubeVideos() {
  ...
  useEffect (()=>{
    fetch("https://www.googleapis.com/youtube/v3/=AIzaSyDU1mxP0dznKYHWsk82IiriAtEIq3uPCd4&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=9")
